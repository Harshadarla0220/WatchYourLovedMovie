...
export default function MovieCard({ movie, onFavoriteChange }: MovieCardProps) {
  ...
  return (
    <Link href={`/movie/${movie.id}`} className="group cursor-pointer">
      <div className="overflow-hidden hover-lift transition-all duration-300 h-full flex flex-col bg-card border border-border rounded-xl hover:border-primary">
        {/* Movie Poster */}
